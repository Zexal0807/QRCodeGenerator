...
Level::$LEVEL_30 = new Level(
    'LEVEL_30',
    json_decode(file_get_contents(dirname(__FILE__) . "/capacity/LEVEL_30.json"), true)
);

Level::$LEVEL_31 = new Level(
    'LEVEL_31',
...
Level::$LEVEL_33 = new Level(
    'LEVEL_33',
    json_decode(file_get_contents(dirname(__FILE__) . "/capacity/LEVEL_33.json"), true)
);

Level::$LEVEL_34 = new Level(
    'LEVEL_34',
    json_decode(file_get_contents(dirname(__FILE__) . "/capacity/LEVEL_34.json"), true)
);

Level::$LEVEL_35 = new Level(
    'LEVEL_35',
    json_decode(file_get_contents(dirname(__FILE__) . "/capacity/LEVEL_35.json"), true)
);

Level::$LEVEL_36 = new Level(
    'LEVEL_36',
    json_decode(file_get_contents(dirname(__FILE__) . "/capacity/LEVEL_36.json"), true)
);

Level::$LEVEL_37 = new Level(
    'LEVEL_37',
    json_decode(file_get_contents(dirname(__FILE__) . "/capacity/LEVEL_37.json"), true)
);

Level::$LEVEL_38 = new Level(
    'LEVEL_38',
    json_decode(file_get_contents(dirname(__FILE__) . "/capacity/LEVEL_38.json"), true)
);

Level::$LEVEL_39 = new Level(
    'LEVEL_39',
    json_decode(file_get_contents(dirname(__FILE__) . "/capacity/LEVEL_39.json"), true)
);

Level::$LEVEL_40 = new Level(
    'LEVEL_40',
    json_decode(file_get_contents(dirname(__FILE__) . "/capacity/LEVEL_40.json"), true)
);
