...
class PolynomialDivision
{
    ...
    /*
    private static function GaloisField256($v)
    {
        if ($v < 0) {
            return PolynomialDivision::GaloisField256(-$v);
        }
        if ($v > 255) {
            return PolynomialDivision::GaloisField256($v % 256);
        }

        return PolynomialDivision::LogAntilog($v);
    }*/
